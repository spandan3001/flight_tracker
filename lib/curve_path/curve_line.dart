...
class PolylinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final polyline in polylines) {
      ...
      if (isDotted) {
        ...
        if (borderPaint != null && filterPaint != null) {
          _paintLineWithCurve(borderPath, offsets);
          _paintLineWithCurve(filterPath, offsets);
        }
        _paintLineWithCurve(path, offsets);
      }
    }
  ...
  void _paintLineWithCurve(ui.Path path, List<Offset> offsets) {
    if (offsets.isEmpty) {
      return;
    }
